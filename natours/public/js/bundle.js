                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            method: 'POST',
                            url: 'http://192.168.1.105:5000/api/v1/users/login',
                            data: {
                              email: email,
                              password: password
                            }
                    ...
                    while (1) {
                      switch ((_context2.prev = _context2.next)) {
                        case 0:
                          ...
                          return (0, _axios.default)({
                            method: 'GET',
                            url: 'http://192.168.1.105:5000/api/v1/users/logout'
                          });
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          url =
                            type === 'password'
                              ? 'http://192.168.1.105:5000/api/v1/users/updateMyPassword'
                              : 'http://192.168.1.105:5000/api/v1/users/updateMe';
                          _context.next = 4;
                          return (0, _axios.default)({
                            method: 'PATCH',
                            url: url,
